...
contract DeployVaultScript is Script {
    ...
    function run() public {
        ...
        vault.addToken(SepoliaConfig.MOCK_WBTC, 95000e18, 18, "WBTC");  // $95000 BTC
...
// Usage:
// source .env && forge script script/deploy/03_DeployVault.s.sol:DeployVaultScript --rpc-url $SEPOLIA_RPC_URL --broadcast --private-key $DEPLOYER_PRIVATE_KEY --etherscan-api-key $ETHERSCAN_API_KEY --verify -vvvv
