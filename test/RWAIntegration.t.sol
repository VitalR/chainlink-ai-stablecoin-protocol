...
contract RWAIntegrationTest is Test {
    ...
    function setUp() public {
        ousg = new MockOUSG();
        ousgPriceFeed = new MockRWAPriceFeed("OUSG / USD", 10000000000, 500, false);
        
        ousg.mint(user, 1000e18);
        ousg.mint(institutional, 10000e18);
    }
    ...
    function test_complete_e2e_ousg_deposit_with_ai_logic() public {
        ...
        MockRWAPriceFeed e2eOUSGPriceFeed = new MockRWAPriceFeed("OUSG / USD", 10000000000, 500, false);
        ...
        assertEq(answer, 10000000000, "Price feed should show $100.00");
